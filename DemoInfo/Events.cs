...
namespace DemoInfo
{
    ...
    {
        public Player Actor { get; internal set; }
    ...
    public class PlayerSteppedEventArgs : EventArgs
    {
        public Player Stepper { get; internal set; }
    }
    ...
    {
        public Player Jumper { get; internal set; }
    }

    public class PlayerFallEventArgs : EventArgs
    {
        public Player Fallen { get; internal set; }
    ...
    public class WeaponFiredEmptyEventArgs : EventArgs
    {
        public Equipment Weapon { get; internal set; }
    ...
    public class BombDropEventArgs : EventArgs
    {
        public Player Player { get; set; }

        public Equipment Bomb { get; set; }
    }

    public class BombPickUpEventArgs : EventArgs
    {
        public Player Player { get; set; }
            ...
            if (weapon == EquipmentElement.Unknown)
            {
                switch (OriginalString)
                {
                    ...
                    case "tmp":
                        ...
                        Console.WriteLine("Unknown weapon mapped with \"tmp\"");
                        break;
                    case "gravity":
                        weapon = EquipmentElement.Gravity;
                        break;
                    default:
                        Console.WriteLine("Unknown weapon: " + OriginalString + ". Occuring in Equipment.MapEquipment()");
                        Trace.WriteLine("Unknown weapon: " + OriginalString + ". Occuring in Equipment.MapEquipment()");
                        break;
                }
            }
